  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-2xl">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">새 공지사항 작성</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-6">
          ...
          <div>
            <label htmlFor="notice-file-upload" className="block text-sm font-medium text-gray-700 mb-2">
              파일 첨부
            </label>
